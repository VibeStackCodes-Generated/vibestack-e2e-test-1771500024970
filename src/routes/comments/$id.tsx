  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="mx-auto max-w-3xl p-6 gap-6 py-12 space-y-8">
        ...
        <h1 className="text-4xl font-[family-name:var(--font-display)]">{String(row.author_name ?? 'Comment')}</h1>
        <section className="space-y-2"><h2 className="text-xl font-[family-name:var(--font-display)]">Details</h2><dl>
              <div className="py-2 border-b last:border-0">
                <dt className="text-xs uppercase tracking-wide text-muted-foreground">Post Id</dt>
                <dd className="text-sm mt-1">{String(row.post_id ?? '—')}</dd>
              </div>
              <div className="py-2 border-b last:border-0">
              ...
              <div className="py-2 border-b last:border-0">
                <dt className="text-xs uppercase tracking-wide text-muted-foreground">Author Email</dt>
                <dd className="text-sm mt-1">{String(row.author_email ?? '—')}</dd>
              </div>
              <div className="py-2 border-b last:border-0">
        ...
        <Link to="/comments/"><Button variant="outline" className="transition-all duration-200">Back to Comments</Button></Link>
      </article>
    </div>
  )
}
